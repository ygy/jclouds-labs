      ...
      public abstract static class WinRM {
          public enum ListenerProtocol {
              ...
              public static ListenerProtocol fromValue(String value) {
                 ...
                 return (ListenerProtocol) GetEnumValue.fromValueOrDefault(value, UNRECOGNIZED);
              }
          ...
          public abstract static class ProtocolListener {
             ...
             public abstract ListenerProtocol protocol();

             @Nullable
             public abstract String certificateUrl();

             @SerializedNames({"protocol", "certificateUrl"})
             public static ProtocolListener create(final ListenerProtocol protocol, final String certificateUrl) {
